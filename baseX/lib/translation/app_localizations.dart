...
class AppLocalizationsX<T> {
  ...
  LocalizationsDelegate<AppLocalizationsX<T>> delegate =
      _AppLocalizationsXDelegate();
...
class _AppLocalizationsXDelegate<T>
    extends LocalizationsDelegate<AppLocalizationsX<T>> {
